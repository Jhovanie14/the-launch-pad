                ...
                <form className="space-y-6">
                  ...
                  <div className="space-y-3">
                    <p className="text-sm text-gray-400">
                      ...
                      communications from The Launch Pad related to your
                      booking. Standard message and data rates apply. Message
                      frequency varies. The Launch Pad will not share your
                      contact phone number with any third parties. Reply STOP to
                      cancel.{" "}
                      <a
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      >
                        I agree to receive promotional messages about new
