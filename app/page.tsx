            ...
            <div className=" py-16 md:py-20">
              <div className="max-w-4xl mb-16">
                ...
                <p className="max-w-2xl text-xl text-muted-foreground leading-relaxed">
                  From DIY car washing to professional detailing and delicious
                  food trucks, The Launch Pad is your complete automotive and
                  dining destination.
                </p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
                <Card className="p-6">
                  ...
                  <CardContent>
                    ...
                    <p className="text-sm mb-8 text-muted-foreground">
                      Easy-to-use self-service car wash bays for those who
                      prefer a hands-on clean! Wash your car your way with
                      professional-grade equipment, including high-pressure
                      hoses, foam brushes, and powerful vacuums — all available
                      at your convenience.
                    </p>
                ...
                <Card className="p-6">
                  ...
                  <CardContent>
                    ...
                    <p className="text-sm mb-8 text-muted-foreground">
                      Give your vehicle the ultimate refresh with our
                      professional car detailing services! We go beyond a basic
                      wash — our detailing packages include deep interior
                      cleaning, premium waxing, and polishing to bring back your
                      car's showroom shine.
                    </p>
                    <div className="space-y-3">
                      <span className="flex text-sm gap-2">
                        <Check className="w-4 h-4 text-muted-foreground" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4 p-3">
                  ...
                  <p>
                    ...
                    detailing, or grab a quick $15 handwash, we've got you
                    covered.
                  </p>
                  <p>
                    Plus, while you wait, enjoy Houston's finest food trucks!
                    It's the perfect way to turn car maintenance into an
